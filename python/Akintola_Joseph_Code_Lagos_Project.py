#   NAME: AKINTOLA JOSEPH TAIWO
#   COURSE: INTRODUCTION TO PYTHON PROGRAMMING
#   PROJECT TOPIC: BUILDING CALCULATOR WITH PYTHON CODES ("A GUI AND LAMBDA FUNCTION APPROACH") 
#   ADDRESS: 96, OGUNGUNMI STREET, ABARANJE, IKOTUN, LAGOS
#   E-MAIL ADDRESS: akinsjoe98@gmail.com
#   INSTITUTION: CODE LAGOS
...
textDisplay =Entry(cal,font=('arial', 20,'bold'), textvariable=text_Input, bd=30, insertwidth=4, justify='right').grid(columnspan=4)
...
btnclear=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial', 20,'bold'),
            text="CE", bg="powder blue",command=btnClearDisplay).grid(row=4,column=1)
